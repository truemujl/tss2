...
export default function NewTelegramAuth() {
  ...
  if (!isClient) {
    return (
      <div 
        className="w-full flex items-center justify-center gap-3 bg-[#0088cc] hover:bg-[#0099dd] text-white font-medium py-4 rounded-xl mb-6 transition-all cursor-pointer opacity-0"
